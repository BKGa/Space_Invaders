...
class AlienFleet:
    ...
    alien_images2 = [pg.image.load(f'images/greenalien{n}.png') for n in range(3)]
    alien_images1 = [pg.image.load(f'images/purplealien{n}.png') for n in range(3)]
    alien_images0 = [pg.image.load(f'images/angryalien{n}.png') for n in range(3)]
    ...
    def __init__(self, game, v=Vector(1, 0)):
        ...
        self.v = v
        alien = Alien(self.game, sound = self.sound, alien_index=0, image_list=AlienFleet.alien_images) #add sound
    ...
    def get_number_rows(self, ship_height, alien_height):
        spacey = self.settings.screen_height - 1 * alien_height - ship_height
...
class UFO(Alien):
    def __init__(self, game, image_list, alien_index, sound, start_index=0, ul=(0, 100), v=Vector(1, 0)):
        super().__init__()
        image = AlienFleet.alien_images[4]
