    ...
    def __init__(self, game, ul, wh):
        ...
        for row in range(wh[0]):
            for col in range(wh[1]):
                be = BarrierElement(game=game, img_list=[pg.image.load(f'images/greenalien0.png')],
...
class BarrierElement(Sprite):
    def __init__(self, game, img_list, ul, wh):
        ...
        self.timer = CommandTimer(image_list=[pg.image.load(f'images/greenalien0.png')], is_loop=False)
